...
1. **需求对账（阶段 7）**：读 spec.md + design.md，按技能 `C:/Users/10042/.zcode/skills/spec-vs-impl-checker/SKILL.md`（给绝对路径自己读）把需求逐条追溯到代码、核对接口契约，产出缺口矩阵（VERIFIED/PARTIAL/MISSING/DEVIATED），落盘 `.agent-team/spec-verify-matrix.md`
