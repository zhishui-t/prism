...
`run-e2e.mjs` 在**单个临时目录**内串起 21 组共 160 项断言：
...
| 8 | 服务：health/kb/graph/arch 等 API + 控制台页面 + SPA 回退 |
...
| 19 | design-v4 §6 验收补充（F-A1/A2/A4/B4/C1/C3/D2/E2）——含 v6 增删改：`team new/edit/rm`、`role new/edit/rm` |
